...
export default function Todo() {
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            task: yup.string().required("required filed"),
            desc: yup.string().required("required filed"),
            priority: yup.string().required("required filed"),
                            ...
                            <div className="card-body">
                                <form onSubmit={formik.handleSubmit}>
                                    <div>
                                        ...
                                        <input
                                            value={() => settask(formik.values.task)}
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <input
                                            value={() => setdesc(formik.values.desc)}
                                            onChange={formik.handleChange}
                                            type="text"
                                            className="form-control"
                                            id="desc"
                                    ...
                                    <div className="mt-2">
                                        ...
                                        <select
                                            value={() => setpriority(formik.values.priority)}
                                            onChange={formik.handleChange} className="form-select" id="priority">
